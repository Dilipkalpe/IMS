...
function PurchaseReturnWorkspaceInner({ lineCount = 0 }: { lineCount?: number }) {
  ...
  return (
    <RefinedScreenShell className="sales-invoice-workspace-screen">
      <div className="si-workspace" data-wpf-source="Views/PurchaseReturnWorkspaceView.xaml">
...
export function PurchaseReturnWorkspaceScreen({ lineCount = 0 }: { lineCount?: number }) {
  const { isReady } = usePurchaseReturnRepositoryOptional();
  if (!isReady) {
    return (
      <RefinedScreenShell className="sales-invoice-workspace-screen">
        <div className="si-list-toolbar__status">Preparing purchase return workspace…</div>
      </RefinedScreenShell>
    );
  }
  return (
    <PurchaseReturnWorkspaceProvider lineCount={lineCount}>
      <PurchaseReturnWorkspaceInner lineCount={lineCount} />
    </PurchaseReturnWorkspaceProvider>
  );
}
