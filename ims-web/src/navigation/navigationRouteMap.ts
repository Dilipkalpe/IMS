...
export const navigationRouteMap: Record<string, string> = {
  ...
  // Module hubs
  [NavKeys.Sales]: 'Views/SalesHubView.xaml',
  [NavKeys.Manufacturing]: 'Views/ManufacturingHubView.xaml',
  [NavKeys.PayrollHr]: 'Views/PayrollHubView.xaml',
  [NavKeys.Inventory]: 'Views/InventoryHubView.xaml',
  [NavKeys.Finance]: 'Views/FinanceHubView.xaml',
  [NavKeys.Insights]: 'Views/InsightsHubView.xaml',
  [NavKeys.ArAp]: 'Views/ArApHubView.xaml',
  [NavKeys.InventoryInsights]: 'Views/InventoryInsightsHubView.xaml',
  [NavKeys.FinancialReports]: 'Views/FinancialReportsHubView.xaml',
  [NavKeys.TransactionReports]: 'Views/TransactionReportsHubView.xaml',
  [NavKeys.MasterData]: 'Views/MasterDataHubView.xaml',
  [NavKeys.UserAdministration]: 'Views/UserAdministrationHubView.xaml',
  [NavKeys.Platform]: 'Views/PlatformHubView.xaml',
  [NavKeys.BulkImport]: 'Views/BulkImportHubView.xaml',
  ...
  [NavKeys.Procurement]: 'Views/ProcurementHubView.xaml',
