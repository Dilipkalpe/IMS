/* AUTO-GENERATED from WPF: Views/PaymentVoucherEntryView.xaml — UI only; refine for pixel parity */
import './PaymentVoucherEntryView.scss';
import { placeholders } from '../../placeholders';

export interface PaymentVoucherEntryViewProps {
  className?: string;
}

export function PaymentVoucherEntryView({ className }: PaymentVoucherEntryViewProps) {
  return (
    <div className={['wpf-root', 'PaymentVoucherEntryView', className].filter(Boolean).join(' ')} data-wpf-source="Views/PaymentVoucherEntryView.xaml">
            ...
            <div className="wpf-grid">
              ...
              <div className="wpf-scrollviewer">
                <div style={{"display":"flex","flexDirection":"column"}} className="wpf-stackpanel">
                  ...
                  <span className="wpf-textblock wpf-subpagesectionheader">{"Payment details"} </span>
                  <div style={{"margin":"0 0 6 0"}} className="wpf-uniformgrid">
                    <div style={{"display":"flex","flexDirection":"column"}} className="wpf-stackpanel wpf-subpagefieldcell">
              ...
              <span className="wpf-textblock wpf-subpagefooternote">{"Save posts the voucher to MongoDB and returns to the list unless “Clear form after save” is checked."} </span>
            </div>
          </div>
        </div>
      </div>
...
export default PaymentVoucherEntryView;
