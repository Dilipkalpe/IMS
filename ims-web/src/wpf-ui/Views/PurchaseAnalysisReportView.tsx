/* AUTO-GENERATED from WPF: Views/PurchaseAnalysisReportView.xaml — UI only; refine for pixel parity */
import './PurchaseAnalysisReportView.scss';
import { placeholders } from '../../placeholders';

export interface PurchaseAnalysisReportViewProps {
  className?: string;
}

export function PurchaseAnalysisReportView({ className }: PurchaseAnalysisReportViewProps) {
  return (
    <div className={['wpf-root', 'PurchaseAnalysisReportView', className].filter(Boolean).join(' ')} data-wpf-source="Views/PurchaseAnalysisReportView.xaml">
        ...
        <div className="wpf-standardreportview.filtercontent">
          <div style={{"display":"grid","gridTemplateColumns":"1fr"}} className="wpf-grid">
            ...
            <div style={{"margin":"0 12 0 0","display":"flex","flexDirection":"column"}} className="wpf-stackpanel">
              <span className="wpf-textblock wpf-solistreportfieldlabel">{"Supplier"} </span>
              <input type="text" style={{"padding":"6 8","fontSize":"13px"}} className="wpf-textbox" onChange={() => placeholders.noop()} />
            </div>
            <div style={{"margin":"0 12 0 0","display":"flex","flexDirection":"column"}} className="wpf-stackpanel">
...
export default PurchaseAnalysisReportView;
