/* AUTO-GENERATED from WPF: Views/PurchaseInvoiceWorkspaceView.xaml — UI only; refine for pixel parity */
import './PurchaseInvoiceWorkspaceView.scss';
import { placeholders } from '../../placeholders';

export interface PurchaseInvoiceWorkspaceViewProps {
  className?: string;
}

export function PurchaseInvoiceWorkspaceView({ className }: PurchaseInvoiceWorkspaceViewProps) {
  return (
    <div className={['wpf-root', 'PurchaseInvoiceWorkspaceView', className].filter(Boolean).join(' ')} data-wpf-source="Views/PurchaseInvoiceWorkspaceView.xaml">
...
export default PurchaseInvoiceWorkspaceView;
