/* AUTO-GENERATED from WPF: Views/CreditNoteEntryView.xaml — UI only; refine for pixel parity */
import './CreditNoteEntryView.scss';
import { placeholders } from '../../placeholders';

export interface CreditNoteEntryViewProps {
  className?: string;
}

export function CreditNoteEntryView({ className }: CreditNoteEntryViewProps) {
  return (
    <div className={['wpf-root', 'CreditNoteEntryView', className].filter(Boolean).join(' ')} data-wpf-source="Views/CreditNoteEntryView.xaml">
        ...
        <div className="wpf-transactionentryshell.titlerightheader">
          <div style={{"display":"flex","flexDirection":"row"}} className="wpf-stackpanel">
            ...
            <div style={{"padding":"4 10"}} className="wpf-border wpf-mockbadge">
              <span style={{"fontSize":"12px"}} className="wpf-textblock wpf-accentbrush">{placeholders.VoucherTypeLabel} </span>
            </div>
          </div>
        </div>
...
export default CreditNoteEntryView;
