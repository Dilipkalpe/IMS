/* AUTO-GENERATED from WPF: Views/FinancialStatementReportView.xaml — UI only; refine for pixel parity */
import './FinancialStatementReportView.scss';
import { placeholders } from '../../placeholders';

export interface FinancialStatementReportViewProps {
  className?: string;
}

export function FinancialStatementReportView({ className }: FinancialStatementReportViewProps) {
  return (
    <div className={['wpf-root', 'FinancialStatementReportView', className].filter(Boolean).join(' ')} data-wpf-source="Views/FinancialStatementReportView.xaml">
        ...
        <div className="wpf-standardreportview.gridcontent">
          <table className="wpf-datagrid wpf-solistordersgrid">
            <div className="wpf-datagrid.columns">
              ...
              <div style={{"width":"170px"}} className="wpf-datagridtextcolumn">
                <div className="wpf-datagridtextcolumn.elementstyle">
                  <div className="wpf-style" />
                </div>
              </div>
...
export default FinancialStatementReportView;
