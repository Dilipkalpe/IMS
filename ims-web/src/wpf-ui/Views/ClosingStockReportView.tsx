/* AUTO-GENERATED from WPF: Views/ClosingStockReportView.xaml — UI only; refine for pixel parity */
import './ClosingStockReportView.scss';
import { placeholders } from '../../placeholders';

export interface ClosingStockReportViewProps {
  className?: string;
}

export function ClosingStockReportView({ className }: ClosingStockReportViewProps) {
  return (
    <div className={['wpf-root', 'ClosingStockReportView', className].filter(Boolean).join(' ')} data-wpf-source="Views/ClosingStockReportView.xaml">
      ...
      <div className="wpf-standardreportview">
        <div className="wpf-standardreportview.filtercontent">
          <div style={{"display":"grid","gridTemplateColumns":"1fr"}} className="wpf-grid">
            ...
            <div style={{"margin":"0 12 10 0","display":"flex","flexDirection":"column"}} className="wpf-stackpanel">
              <span className="wpf-textblock wpf-solistreportfieldlabel">{"Main Name"} </span>
            ...
            <div style={{"margin":"0 12 10 0","display":"flex","flexDirection":"column"}} className="wpf-stackpanel">
              <span className="wpf-textblock wpf-solistreportfieldlabel">{"Item Description"} </span>
              <input type="text" style={{"padding":"6 8","fontSize":"13px"}} className="wpf-textbox" onChange={() => placeholders.noop()} />
            </div>
            ...
            <div style={{"margin":"0 12 0 0","display":"flex","flexDirection":"column"}} className="wpf-stackpanel">
              <span className="wpf-textblock wpf-solistreportfieldlabel">{"Godown"} </span>
              <select style={{"padding":"6 8","fontSize":"13px"}} className="wpf-combobox wpf-formcombo" />
            </div>
            ...
            <div style={{"margin":"0 0 0 0","display":"flex","flexDirection":"column"}} className="wpf-stackpanel">
              <span className="wpf-textblock wpf-solistreportfieldlabel">{"Batch No"} </span>
              <input type="text" style={{"padding":"6 8","fontSize":"13px"}} className="wpf-textbox" onChange={() => placeholders.noop()} />
            </div>
