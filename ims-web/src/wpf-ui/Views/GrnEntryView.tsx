/* AUTO-GENERATED from WPF: Views/GrnEntryView.xaml — UI only; refine for pixel parity */
import './GrnEntryView.scss';
import { placeholders } from '../../placeholders';

export interface GrnEntryViewProps {
  className?: string;
}

export function GrnEntryView({ className }: GrnEntryViewProps) {
  return (
    <div className={['wpf-root', 'GrnEntryView', className].filter(Boolean).join(' ')} data-wpf-source="Views/GrnEntryView.xaml">
          ...
          <div style={{"margin":"0 6 6 0","padding":"10"}} className="wpf-border wpf-transactionsectionborder">
            <div className="wpf-grid">
              ...
              <div className="wpf-uniformgrid">
                ...
                <div style={{"display":"flex","flexDirection":"column"}} className="wpf-stackpanel wpf-subpagefieldcell">
                  <span className="wpf-textblock wpf-subpageformlabel">{"GRN No"} </span>
                  <input type="text" className="wpf-textbox wpf-subpageforminput" onChange={() => placeholders.noop()} />
                </div>
                <div style={{"display":"flex","flexDirection":"column"}} className="wpf-stackpanel wpf-subpagefieldcell">
                  <span className="wpf-textblock wpf-subpageformlabel">{"GRN Date"} </span>
                ...
                <div style={{"display":"flex","flexDirection":"column"}} className="wpf-stackpanel wpf-subpagefieldcell">
                  <span className="wpf-textblock wpf-subpageformlabel">{"PO Reference"} </span>
                  <input type="text" className="wpf-textbox wpf-subpageforminput" onChange={() => placeholders.noop()} />
                </div>
                <div style={{"display":"flex","flexDirection":"column"}} className="wpf-stackpanel wpf-subpagefieldcell">
