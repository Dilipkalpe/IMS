/* AUTO-GENERATED from WPF: Views/GrnWorkspaceView.xaml — UI only; refine for pixel parity */
import './GrnWorkspaceView.scss';
import { placeholders } from '../../placeholders';

export interface GrnWorkspaceViewProps {
  className?: string;
}

export function GrnWorkspaceView({ className }: GrnWorkspaceViewProps) {
  return (
    <div className={['wpf-root', 'GrnWorkspaceView', className].filter(Boolean).join(' ')} data-wpf-source="Views/GrnWorkspaceView.xaml">
...
export default GrnWorkspaceView;
