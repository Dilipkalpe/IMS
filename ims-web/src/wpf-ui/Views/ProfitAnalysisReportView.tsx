/* AUTO-GENERATED from WPF: Views/ProfitAnalysisReportView.xaml — UI only; refine for pixel parity */
import './ProfitAnalysisReportView.scss';
import { placeholders } from '../../placeholders';

export interface ProfitAnalysisReportViewProps {
  className?: string;
}

export function ProfitAnalysisReportView({ className }: ProfitAnalysisReportViewProps) {
  return (
    <div className={['wpf-root', 'ProfitAnalysisReportView', className].filter(Boolean).join(' ')} data-wpf-source="Views/ProfitAnalysisReportView.xaml">
...
export default ProfitAnalysisReportView;
