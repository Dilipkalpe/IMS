/* AUTO-GENERATED from WPF: Views/SalesReturnWorkspaceView.xaml — UI only; refine for pixel parity */
import './SalesReturnWorkspaceView.scss';
import { placeholders } from '../../placeholders';

export interface SalesReturnWorkspaceViewProps {
  className?: string;
}

export function SalesReturnWorkspaceView({ className }: SalesReturnWorkspaceViewProps) {
  return (
    <div className={['wpf-root', 'SalesReturnWorkspaceView', className].filter(Boolean).join(' ')} data-wpf-source="Views/SalesReturnWorkspaceView.xaml">
...
export default SalesReturnWorkspaceView;
