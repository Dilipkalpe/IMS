/* AUTO-GENERATED from WPF: Views/ReorderLevelReportView.xaml — UI only; refine for pixel parity */
import './ReorderLevelReportView.scss';
import { placeholders } from '../../placeholders';

export interface ReorderLevelReportViewProps {
  className?: string;
}

export function ReorderLevelReportView({ className }: ReorderLevelReportViewProps) {
  return (
    <div className={['wpf-root', 'ReorderLevelReportView', className].filter(Boolean).join(' ')} data-wpf-source="Views/ReorderLevelReportView.xaml">
...
export default ReorderLevelReportView;
