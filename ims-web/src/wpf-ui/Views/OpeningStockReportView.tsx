/* AUTO-GENERATED from WPF: Views/OpeningStockReportView.xaml — UI only; refine for pixel parity */
import './OpeningStockReportView.scss';
import { placeholders } from '../../placeholders';

export interface OpeningStockReportViewProps {
  className?: string;
}

export function OpeningStockReportView({ className }: OpeningStockReportViewProps) {
  return (
    <div className={['wpf-root', 'OpeningStockReportView', className].filter(Boolean).join(' ')} data-wpf-source="Views/OpeningStockReportView.xaml">
...
export default OpeningStockReportView;
