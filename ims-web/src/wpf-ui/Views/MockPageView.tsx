/* AUTO-GENERATED from WPF: Views/MockPageView.xaml — UI only; refine for pixel parity */
import './MockPageView.scss';
import { placeholders } from '../../placeholders';

export interface MockPageViewProps {
  className?: string;
}

export function MockPageView({ className }: MockPageViewProps) {
  return (
    <div className={['wpf-root', 'MockPageView', className].filter(Boolean).join(' ')} data-wpf-source="Views/MockPageView.xaml">
      ...
      <div className="wpf-transactionentryshell">
        <div style={{"margin":"0"}} className="wpf-grid">
          ...
          <div style={{"margin":"0 0 10 0"}} className="wpf-itemscontrol">
            <div className="wpf-itemscontrol.style">
            ...
            <div className="wpf-itemscontrol.itemtemplate">
              <div className="wpf-datatemplate">
                <button type="button" style={{"margin":"0 10 0 0"}} className="wpf-button wpf-actionbutton" onClick={() => placeholders.noop()} />
              </div>
            </div>
          </div>
