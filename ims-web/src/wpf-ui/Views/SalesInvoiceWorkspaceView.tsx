/* AUTO-GENERATED from WPF: Views/SalesInvoiceWorkspaceView.xaml — UI only; refine for pixel parity */
import './SalesInvoiceWorkspaceView.scss';
import { placeholders } from '../../placeholders';

export interface SalesInvoiceWorkspaceViewProps {
  className?: string;
}

export function SalesInvoiceWorkspaceView({ className }: SalesInvoiceWorkspaceViewProps) {
  return (
    <div className={['wpf-root', 'SalesInvoiceWorkspaceView', className].filter(Boolean).join(' ')} data-wpf-source="Views/SalesInvoiceWorkspaceView.xaml">
...
export default SalesInvoiceWorkspaceView;
