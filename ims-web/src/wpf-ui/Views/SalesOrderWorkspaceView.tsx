/* AUTO-GENERATED from WPF: Views/SalesOrderWorkspaceView.xaml — UI only; refine for pixel parity */
import './SalesOrderWorkspaceView.scss';
import { placeholders } from '../../placeholders';

export interface SalesOrderWorkspaceViewProps {
  className?: string;
}

export function SalesOrderWorkspaceView({ className }: SalesOrderWorkspaceViewProps) {
  return (
    <div className={['wpf-root', 'SalesOrderWorkspaceView', className].filter(Boolean).join(' ')} data-wpf-source="Views/SalesOrderWorkspaceView.xaml">
...
export default SalesOrderWorkspaceView;
