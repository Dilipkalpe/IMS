/* AUTO-GENERATED from WPF: Views/DueAmountReportView.xaml — UI only; refine for pixel parity */
import './DueAmountReportView.scss';
import { placeholders } from '../../placeholders';

export interface DueAmountReportViewProps {
  className?: string;
}

export function DueAmountReportView({ className }: DueAmountReportViewProps) {
  return (
    <div className={['wpf-root', 'DueAmountReportView', className].filter(Boolean).join(' ')} data-wpf-source="Views/DueAmountReportView.xaml">
...
export default DueAmountReportView;
