/* AUTO-GENERATED from WPF: Views/StockMovementReportView.xaml — UI only; refine for pixel parity */
import './StockMovementReportView.scss';
import { placeholders } from '../../placeholders';

export interface StockMovementReportViewProps {
  className?: string;
}

export function StockMovementReportView({ className }: StockMovementReportViewProps) {
  return (
    <div className={['wpf-root', 'StockMovementReportView', className].filter(Boolean).join(' ')} data-wpf-source="Views/StockMovementReportView.xaml">
      ...
      <div className="wpf-standardreportview">
        <div className="wpf-standardreportview.filtercontent">
          <div style={{"display":"grid","gridTemplateColumns":"1fr"}} className="wpf-grid">
            ...
            <div style={{"margin":"0 12 0 0","display":"flex","flexDirection":"column"}} className="wpf-stackpanel">
              <span className="wpf-textblock wpf-solistreportfieldlabel">{"Movement Type"} </span>
