/* AUTO-GENERATED from WPF: Views/ReceiptVoucherEntryView.xaml — UI only; refine for pixel parity */
import './ReceiptVoucherEntryView.scss';
import { placeholders } from '../../placeholders';

export interface ReceiptVoucherEntryViewProps {
  className?: string;
}

export function ReceiptVoucherEntryView({ className }: ReceiptVoucherEntryViewProps) {
  return (
    <div className={['wpf-root', 'ReceiptVoucherEntryView', className].filter(Boolean).join(' ')} data-wpf-source="Views/ReceiptVoucherEntryView.xaml">
        ...
        <div className="wpf-transactionentryshell.titlerightheader">
          <div style={{"display":"flex","flexDirection":"row"}} className="wpf-stackpanel">
            ...
            <div style={{"padding":"4 10"}} className="wpf-border wpf-mockbadge">
              <span style={{"fontSize":"12px"}} className="wpf-textblock wpf-successbrush">{placeholders.VoucherTypeLabel} </span>
            </div>
          </div>
        </div>
            ...
            <div className="wpf-grid">
              ...
              <div className="wpf-scrollviewer">
                <div style={{"display":"flex","flexDirection":"column"}} className="wpf-stackpanel">
                  ...
                  <span className="wpf-textblock wpf-subpagesectionheader">{"Receipt details"} </span>
                  <div style={{"margin":"0 0 6 0"}} className="wpf-uniformgrid">
                    <div style={{"display":"flex","flexDirection":"column"}} className="wpf-stackpanel wpf-subpagefieldcell">
              ...
              <span className="wpf-textblock wpf-subpagefooternote">{"Save posts the receipt to MongoDB and returns to the list unless “Clear form after save” is checked. Customer accounts are used for receipts."} </span>
            </div>
          </div>
        </div>
      </div>
...
export default ReceiptVoucherEntryView;
