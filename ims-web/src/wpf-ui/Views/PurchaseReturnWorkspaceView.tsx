/* AUTO-GENERATED from WPF: Views/PurchaseReturnWorkspaceView.xaml — UI only; refine for pixel parity */
import './PurchaseReturnWorkspaceView.scss';
import { placeholders } from '../../placeholders';

export interface PurchaseReturnWorkspaceViewProps {
  className?: string;
}

export function PurchaseReturnWorkspaceView({ className }: PurchaseReturnWorkspaceViewProps) {
  return (
    <div className={['wpf-root', 'PurchaseReturnWorkspaceView', className].filter(Boolean).join(' ')} data-wpf-source="Views/PurchaseReturnWorkspaceView.xaml">
...
export default PurchaseReturnWorkspaceView;
