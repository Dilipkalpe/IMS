/* AUTO-GENERATED from WPF: Views/PurchaseOrderWorkspaceView.xaml — UI only; refine for pixel parity */
import './PurchaseOrderWorkspaceView.scss';
import { placeholders } from '../../placeholders';

export interface PurchaseOrderWorkspaceViewProps {
  className?: string;
}

export function PurchaseOrderWorkspaceView({ className }: PurchaseOrderWorkspaceViewProps) {
  return (
    <div className={['wpf-root', 'PurchaseOrderWorkspaceView', className].filter(Boolean).join(' ')} data-wpf-source="Views/PurchaseOrderWorkspaceView.xaml">
...
export default PurchaseOrderWorkspaceView;
