 ...
 */
export function summarizeSalesOrderLines(lines, totals) {
  let totalTaxable = 0;
  let totalCgst = 0;
  let totalSgst = 0;
  let totalIgst = 0;
 ...
 */
export function toSalesOrderListItem(doc) {
  const summary = summarizeSalesOrderLines(doc.lines, doc.totals);
  return {
    id: String(doc._id),
...
export { resolveSalesOrderSort, fetchSalesOrderListPage, fetchSalesOrderListResponse } from './salesOrderListQuery.js';
