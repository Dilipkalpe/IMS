...
public sealed class AddPurchaseReturnViewModel : PurchaseDocumentEntryViewModelBase
{
    ...
    public AddPurchaseReturnViewModel(MainViewModel host, PurchaseReturnWorkspaceViewModel workspace, int docNo)
        : this(host, workspace, docNo, forEdit: false)
    {
    }

    public AddPurchaseReturnViewModel(
        MainViewModel host,
        PurchaseReturnWorkspaceViewModel workspace,
        int docNo,
        bool forEdit)
